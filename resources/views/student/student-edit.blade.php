                        ...
                        <div class="card-body">
                            <form action="{{route('student.edit')}}" method="post">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="seid" value="{{$student->seid}}" class="form-control" placeholder="input Your seid">
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    <label for="" class="col-md-3 form-label"> <b>Name</b></label>
                                    <div class="col-md-9">
                                        <input type="text" name="name" value="{{$student->name}}" class="form-control" placeholder="input Your name">
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    <label for="" class="col-md-3 form-label"><b>email</b></label>
                                    <div class="col-md-9">
                                        <input type="email" name="email"  value="{{$student->email}}" class="form-control" placeholder="input Your email">
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    <label for="" class="col-md-3 form-label"><b>Phone</b></label>
                                    <div class="col-md-9">
                                        <input type="text" name="phone"  value="{{$student->phone}}" class="form-control" placeholder="input Your phone number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="course_name"  value="{{$student->course_name}}" class="form-control" placeholder="input Your course">
                                    </div>
                                </div>
...
{{--                                            <option value="OTHER">OTHER</option>--}}
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="address" id="" cols="20" rows="5">{{$student->address}}</textarea>
                                    </div>
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="d-grid">
                                            <input type="submit" name="btn" value="update" class="btn btn-outline-primary">
                                        </div>

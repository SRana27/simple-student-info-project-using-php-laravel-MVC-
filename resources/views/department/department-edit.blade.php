                        ...
                        <div class="card-body">
                            <form action="{{route('department.edit')}}" method="post">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="dept_code" value="{{$department->dept_code}}" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    <label for="" class="col-md-3 form-label"><b>Department Name</b></label>
                                    <div class="col-md-9">
                                        <input type="text" name="dept_name" value="{{$department->dept_name}}" class="form-control" placeholder="">
                                    </div>
                                </div>
